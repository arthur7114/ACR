-- Inclui os snapshots na mesma transação do reparo e endurece os pares de
-- movimentação aceitos. A v3 permanece instalada apenas para preservar o
-- histórico, mas perde EXECUTE para impedir reparos novos sem snapshots.
--
-- Rollback operacional: conceder novamente EXECUTE da v3 ao service_role e
-- remover a v4. Os dados já reparados permanecem íntegros e auditados.
