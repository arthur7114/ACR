export const documentClassifierAgent = {
  ...
  userPrompt:
    [
      ...
      "relatorio_reajuste e o relatorio mensal de locacao da imobiliaria: titulo como 'RELATORIO VIGENCIA DE <MES>/<ANO>' ou 'RELATORIO LOCACAO', com secoes 'APARTAMENTO ALUGADO', 'ATUALIZACAO MONETARIA' (aluguel do ano anterior x ano atual por apartamento, correcao pelo IPCA/IGP-M), 'ATRASADOS QUE FORAM RECEBIDOS' e 'RESCISAO' (calculo de multa), frequentemente seguido de termos de entrega de chaves e de vistoria. A presenca de 'ATUALIZACAO MONETARIA' ou de tabelas de correcao por indice e evidencia forte de relatorio_reajuste, mesmo com anexos contratuais longos — classifique com confianca alta.",
      "despesas_comprovantes e o conjunto de contas e comprovantes de pagamento do empreendimento (faturas CAGECE/ENEL, boletos de seguro, IPTU, recibos Pix de pagamento), sem demonstrativo de repasse.",
