...
export const prestacaoJsonSchema = {
  ...
  properties: {
    ...
    // Linha TOTAL impressa ao pe de cada secao. Serve de conferencia contra a
    // nossa soma das linhas: divergencia = coluna perdida na extracao.
    totais_secoes: {
      type: "array",
      items: {
        type: "object",
        ...
        properties: {
          secao: {
            type: "string",
            enum: ["vigencia", "intermediacao", "acordos_rescisoes", "inadimplencias"],
          },
