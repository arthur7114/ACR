...
/**
 * Formata uma data-only AAAA-MM-DD como dd/mm/aaaa sem passar por `new Date`
 * (evita o off-by-one de fuso: "2026-05-10" viraria 09/05 em UTC-3). Aceita
 * tambem timestamps completos, usando apenas a parte da data.
 */
