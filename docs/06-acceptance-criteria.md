...
- CA-IND16: o reparo César Rêgo vincula as linhas históricas aos cadastros canônicos existentes e envia à RPC v3 somente receitas `receita_aluguel` e despesas `rateio_ted`, junto das validações e auditoria, sob concorrência otimista. Após o reparo, não há receita César Rêgo sem vínculo válido nem cadastro no empreendimento errado.
